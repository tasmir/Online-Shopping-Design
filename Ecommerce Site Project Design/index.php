			...
			<div class="Product">
				<div class="rightProduct">
					...
					<div class="topSell">
						...
						<?php
						$x=0; 
						$sql = "SELECT * FROM `homepage` WHERE display_mode = 'yes' && podition = 'topsell'";
						...
						<div class="topSellProduct">
							<button pid="topsellProductImg">
								<div class="topSellProductImg"><img src="<?php echo $img.$product_url;?>"></div>
							</button>
							<div class="ratting">
							...
							<div class="topSellProductName"><a href="productDetails.php?pid='<?php echo $product_id;?>'&pur=<?php echo $product_url;?>"><?php echo $product_name;?></a></div>
							<div class="topSellProductPrice">
								<div class="topSellProductPriceOld" style="float: left; visibility: hidden;">old price</div>
								<div class="topSellProductPriceNew" style="float: left; color: orange;">New price</div>
							</div>
							<div class="topSellProductBuyButton">
								<a href="productDetails.php?pid='<?php echo $product_id;?>'&uid='11'&pur=<?php echo $product_url;?>">Buy Now</a>
							</div>
						</div>
						<?php  $x=$x+1; }?>
				...
				<!-- Gents Start -->
					...
					<div class="ganceCalection">
						...
						<div class="rightProduct_middle">
							...
							<?php 
							$x=0;
							$sql = "SELECT * FROM `homepage` WHERE display_mode = 'yes' && podition = 'gents'";
							$result = mysqli_query($con,$sql);
							while (  $var = mysqli_fetch_array($result)) {
								$product_id = $var['product_id'];
								$sql2 = "SELECT * FROM `product` WHERE product_id = '$product_id'";
							...
							?>
								<div class="InTableView-Left" <?php if($x <3) {?> style="border-bottom: 1px solid #b3b3b3;" <?php }?>>
									<div class="InTableView-Left-img">
										<img src="<?php echo $img.$product_url;?>">
									</div>
									<div class="InTableView-Left-details">
										<center>
											...
											<div class="InTableView-Left-details-Name"><a href="productDetails.php?pid='<?php echo $product_id;?>'&pur=<?php echo $product_url;?>"><?php echo $product_name;?></a></div>
					...
					<div class="ganceCalection">
						...
						<div class="rightProduct_middle">
							...
							?>
								...
								<?php $x=$x+1; } ?>
								<!-- <div class="InTableView-Left"></div> -->
								<!-- <div class="InTableView-meddle"></div> -->
								<!-- <div class="InTableView-Right"></div> -->
							</div>
						</div>
						<div class="rightProduct_right_add">
							<img style="position: relative;" src="resorce/pic/plain-black-t-shirt-7-cool-hd-wallpaper.jpg">
